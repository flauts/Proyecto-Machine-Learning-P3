...
features_test = tfidf.transform(test_df.text).toarray()
...
dump(features_test, os.path.join(tfidf_folder, "features_test.joblib"))
dump(labels_test, os.path.join(tfidf_folder, "labels_test.joblib"))